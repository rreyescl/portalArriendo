...
class Propiedades
{
    ...
    public static function getPropiedadesByPropietarioId($id_propietario)
    {
        ...
        $sql = "select * from  propiedades where propietario_id = " . $id_propietario .
            " order by id desc";
    ...
    {
        $conn = Portal::getConexion();
        $sql = "insert into propiedades values (0," . $this->propietario_id . ",'" . $this->
            direccion . "','" . $this->descripcion . "'," . $this->tarifa . "," . $this->
            comuna_id . "," . $this->cantidad_baños . "," . $this->cantidad_habitaciones .
            ")";
        // echo $sql;
    ...
    public static function remove($id_propiedad)
    {
        $conn = Portal::getConexion();
        $arr = array(
            "delete from propiedades where id = " . $id_propiedad,
            "delete from imagenes where propiedad_id =" . $id_propiedad,
            "delete from publicacion where id_propiedad=" . $id_propiedad);
    ...
    {
        $conn = Portal::getConexion();
        $sql = "update propiedades set direccion='" . $this->direccion .
            "', descripcion='" . $this->descripcion . "',tarifa=" . $this->tarifa .
            ", cantidad_banos=" . $this->cantidad_baños . ",cantidad_habitaciones=" . $this->
            cantidad_habitaciones . " where id = " . $this->id;
        mysqli_query($conn, $sql);
